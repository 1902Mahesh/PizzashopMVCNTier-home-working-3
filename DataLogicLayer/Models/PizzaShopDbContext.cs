...
public partial class PizzaShopDbContext : DbContext
{
    ...
    public virtual DbSet<Invoicetaxmapping> Invoicetaxmappings { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customerreview>(entity =>
        {
            ...
            entity.HasOne(d => d.Order).WithMany(p => p.Customerreviews)
                .HasForeignKey(d => d.Orderid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("customerreview_orderid_fkey");
        ...
        modelBuilder.Entity<Invoice>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.InvoiceNo).HasColumnType("character varying");
            entity.Property(e => e.Orderid).HasColumnName("orderid");
        ...
        modelBuilder.Entity<Invoicetaxmapping>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("invoicetaxmapping_pkey");

            entity.ToTable("invoicetaxmapping");
            ...
            entity.HasOne(d => d.Invoice).WithMany(p => p.Invoicetaxmappings)
                .HasForeignKey(d => d.Invoiceid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("invoicetaxmapping_invoiceid_fkey");
        });
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.Property(e => e.TotalPersons).HasDefaultValueSql("1");
            entity.Property(e => e.UpdatedAt)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("updated_at");
            entity.Property(e => e.UpdatedBy).HasColumnName("updated_by");
        ...
        modelBuilder.Entity<Ordertablemapping>(entity =>
        {
            ...
            entity.HasOne(d => d.Order).WithMany(p => p.Ordertablemappings)
                .HasForeignKey(d => d.Orderid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("ordertablemapping_orderid_fkey");

            entity.HasOne(d => d.Table).WithMany(p => p.Ordertablemappings)
                .HasForeignKey(d => d.Tableid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("ordertablemapping_tableid_fkey");
        });
